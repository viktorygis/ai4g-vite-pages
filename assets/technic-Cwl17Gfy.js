import{d as e,t}from"./main-H_sd6AEc.js";import{n,t as r}from"./technics-CD6eWj4z.js";var i=e((()=>{r(),document.addEventListener(`DOMContentLoaded`,async()=>{let e=document.getElementById(`technic-page`);if(!e)return;let t=new URLSearchParams(window.location.search).get(`slug`);if(!t){i(`Техника не найдена`);return}try{let e=n.find(e=>e.slug===t);if(!e){i(`Техника не найдена`);return}r(e)}catch(e){console.error(e),i(`Ошибка загрузки данных`)}function r(t){document.title=t.title||t.subtitle||`Техника развития`;function n(e){return!e||!e.length?``:`
        <ul>
